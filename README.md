**City Builder** is a game engine dedicated to creating **Tile Based, Idle** games written in C. This engine has been set up to be used in VScode on Windows, and targets Desktop (Linux, Windows) or Web only.
